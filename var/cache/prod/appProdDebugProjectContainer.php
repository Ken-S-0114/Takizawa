...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->aliases = array(
            'database_connection' => 'doctrine.dbal.delos_connection',
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('delos' => 'doctrine.dbal.delos_connection'), array('default' => 'doctrine.orm.default_entity_manager'), 'delos', 'default');
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f10f961dab4a2ab4c00d8ec62ac642054f27749f3d3d38f4d00a6165399c6961');
    ...
    {
        $this->services['monolog.handler.nested'] = $instance = new \Monolog\Handler\RotatingFileHandler(($this->targetDirs[2].'/logs/prod.log'), 60, 100, true, NULL);
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59881cdbe1ff72.50772351')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'doctrine.default_connection' => 'delos',
