...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'amalfi_api_info' => 'getAmalfiApiInfoService',
            'annotation_reader' => 'getAnnotationReaderService',
            'api_wrapper' => 'getApiWrapperService',
            'app.exception_controller' => 'getApp_ExceptionControllerService',
            'assets.context' => 'getAssets_ContextService',
            'assets.packages' => 'getAssets_PackagesService',
            'base' => 'getBaseService',
            'base_service' => 'getBaseServiceService',
            'cache_clearer' => 'getCacheClearerService',
            'cache_warmer' => 'getCacheWarmerService',
            'config_cache_factory' => 'getConfigCacheFactoryService',
            'controller_name_converter' => 'getControllerNameConverterService',
            'cookie' => 'getCookieService',
            ...
            'doctrine.dbal.delos_connection' => 'getDoctrine_Dbal_DelosConnectionService',
            'doctrine.dbal.logger' => 'getDoctrine_Dbal_LoggerService',
            'doctrine.dbal.logger.profiling.default' => 'getDoctrine_Dbal_Logger_Profiling_DefaultService',
            'doctrine.dbal.logger.profiling.delos' => 'getDoctrine_Dbal_Logger_Profiling_DelosService',
            ...
            'gmo_error_data' => 'getGmoErrorDataService',
            ...
            'mail' => 'getMailService',
            'mail_model' => 'getMailModelService',
            'member_security' => 'getMemberSecurityService',
    ...
    /**
     * Gets the 'amalfi_api_info' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\AmalfiApiInfo A AppBundle\Service\AmalfiApiInfo instance
     */
    protected function getAmalfiApiInfoService()
    {
        return $this->services['amalfi_api_info'] = new \AppBundle\Service\AmalfiApiInfo($this);
    }
    ...
    /**
     * Gets the 'api_wrapper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\ApiWrapper A AppBundle\Service\ApiWrapper instance
     */
    protected function getApiWrapperService()
    {
        return $this->services['api_wrapper'] = new \AppBundle\Service\ApiWrapper($this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\CustomExceptionController A AppBundle\Controller\CustomExceptionController instance
     */
    protected function getApp_ExceptionControllerService()
    {
        return $this->services['app.exception_controller'] = new \AppBundle\Controller\CustomExceptionController($this->get('twig'), true);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Model\Base A AppBundle\Model\Base instance
     */
    protected function getBaseService()
    {
        return $this->services['base'] = new \AppBundle\Model\Base($this);
    }

    /**
     * Gets the 'base_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\Base A AppBundle\Service\Base instance
     */
    protected function getBaseServiceService()
    {
        return $this->services['base_service'] = new \AppBundle\Service\Base($this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\Cookie A AppBundle\Service\Cookie instance
     */
    protected function getCookieService()
    {
        return $this->services['cookie'] = new \AppBundle\Service\Cookie($this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Model\Db A AppBundle\Model\Db instance
     */
    protected function getDbService()
    {
        return $this->services['db'] = new \AppBundle\Model\Db($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('delos' => 'doctrine.dbal.delos_connection', 'default' => 'doctrine.dbal.default_connection'), array('default' => 'doctrine.orm.default_entity_manager'), 'default', 'default');
    }
     ...
     * @return \Doctrine\DBAL\Connection A Doctrine\DBAL\Connection instance
     */
    protected function getDoctrine_Dbal_DelosConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.delos'));
        ...
        return $this->services['doctrine.dbal.delos_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'delos', 'user' => 'root', 'password' => 'oz-vision123', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'set time_zone = \'+09:00\''), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addCustomStringFunction('GROUP_CONCAT', 'AppBundle\\Extension\\MysqlFunction\\GroupConcatCustomer');

        $this->services['doctrine.orm.default_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.delos_connection'), $b);
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d2397d5b955e07bff2480b92bd5dbe85c58697963882cba0b63a326a5019b7c6');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\FacebookLogin A AppBundle\Service\FacebookLogin instance
     */
    protected function getFacebookService()
    {
        return $this->services['facebook'] = new \AppBundle\Service\FacebookLogin($this);
    }
    ...
    /**
     * Gets the 'gmo_error_data' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\GmoErrorData A AppBundle\Service\GmoErrorData instance
     */
    protected function getGmoErrorDataService()
    {
        return $this->services['gmo_error_data'] = new \AppBundle\Service\GmoErrorData($this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\Mail A AppBundle\Service\Mail instance
     */
    protected function getMailService()
    {
        return $this->services['mail'] = new \AppBundle\Service\Mail($this);
    }

    /**
     * Gets the 'mail_model' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Model\Mail A AppBundle\Model\Mail instance
     */
    protected function getMailModelService()
    {
        return $this->services['mail_model'] = new \AppBundle\Model\Mail($this);
    }

    /**
     * Gets the 'member_security' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\MemberSecurity A AppBundle\Service\MemberSecurity instance
     */
    protected function getMemberSecurityService()
    {
        return $this->services['member_security'] = new \AppBundle\Service\MemberSecurity($this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\Memcached A AppBundle\Service\Memcached instance
     */
    protected function getMemcachedService()
    {
        return $this->services['memcached'] = new \AppBundle\Service\Memcached();
    }
    ...
    protected function getProfilerService()
    {
        ...
        $c->addLogger('delos', $this->get('doctrine.dbal.logger.profiling.delos'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\Security A AppBundle\Service\Security instance
     */
    protected function getSecurityService()
    {
        return $this->services['security'] = new \AppBundle\Service\Security($this);
    }
    ...
    protected function getSerializerService()
    {
        ...
        $a->setNamespace('serializer_99172e95bb1ce2f8428f21ef9678588e20aaa76ac61e6f224b2dcabfeb7f5163');

        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer(array(0 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(new \Symfony\Component\Serializer\Mapping\Factory\ClassMetadataFactory(new \Symfony\Component\Serializer\Mapping\Loader\LoaderChain(array()), $a), NULL, $this->get('property_accessor'))), array(0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder()));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $instance->setHost('mail01.zoto.gift');
        $instance->setPort(25);
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'AppBundle:CustomException:show', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    {
        return $this->services['twig.controller.preview_error'] = new \Symfony\Bundle\TwigBundle\Controller\PreviewErrorController($this->get('http_kernel'), 'AppBundle:CustomException:show');
    }
    ...
    {
        return $this->services['twig.exception_listener'] = new \Symfony\Component\HttpKernel\EventListener\ExceptionListener('AppBundle:CustomException:show', $this->get('monolog.logger.request', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /**
     * Gets the 'doctrine.dbal.logger.profiling.delos' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Doctrine\DBAL\Logging\DebugStack A Doctrine\DBAL\Logging\DebugStack instance
     */
    protected function getDoctrine_Dbal_Logger_Profiling_DelosService()
    {
        return $this->services['doctrine.dbal.logger.profiling.delos'] = new \Doctrine\DBAL\Logging\DebugStack();
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5985a710957973.41454762')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_name' => 'delos',
            'database_user' => 'root',
            'database_password' => 'oz-vision123',
            'database_charset' => 'UTF8',
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'mailer_transport' => 'smtp',
            'mailer_encryption' => 'ssl',
            'mailer_auth_mode' => 'plain',
            'mailer_host' => 'mail01.zoto.gift',
            'mailer_user' => 'cs',
            'security_key' => 'camel_peace',
            'zoto_url' => 'http://localhost:8908/',
            'zoto_url_ssl' => 'http://localhost:8908/',
            'zoto_env' => 'local',
            'info_dev_mail' => 'info_dev@zoto.gift',
            'gmo_secure' => '1',
            'amalfi_api' => array(
                'settings' => array(
                    'api_key' => '1234',
                    'provider_key' => 'wai',
                    'main_url' => 'http://dev-api.zoto.gift/',
                ),
                'apis' => array(
                    'token' => 'token',
                    'login' => 'login',
                    'ticket_payout' => 'ticket/pay_out',
                    'hapitas_login' => 'hapitas/login',
                    'hapitas_register' => 'hapitas/register',
                    'register' => 'register',
                    ...
                    'card' => 'cards',
                    'ticket' => 'ticket',
                    'payment_purchase_histories' => 'payment/purchase/histories',
                    'member_received_gifts' => 'member/received/gifts',
                    'items_brand' => 'items/brand',
                    'member_find' => 'member/find',
                    'double_mail' => 'member/mail',
                    'password_reminder' => 'member/password/remind',
                    'password_update' => 'member/password/update',
                    'profile_update' => 'member/profile/update',
                    'ranking' => 'gift/ranking',
                    'create_guest' => 'guest/create',
                    'gmo_payment_entry' => 'gmo/payment/entry',
                    'gmo_payment_exec' => 'gmo/payment/exec',
                    'gmo_payment_secure_exec' => 'gmo/payment/secure/exec',
                    'gmo_payment_secure' => 'gmo/payment/secure',
                    'gmo_payment_exec_card' => 'gmo/payment/exec/card',
                    'gmo_payment_secure_exec_card' => 'gmo/payment/secure/exec/card',
                    'gmo_member_save' => 'gmo/payment/member/save',
                    'gmo_card_traded' => 'gmo/payment/card/traded',
                    'gmo_card_delete' => 'gmo/payment/card/delete',
                    'withdrawal_complete' => 'member/withdrawal',
                    'recommend' => 'gift/recommend',
                    'gmo_card_search' => 'gmo/payment/card/search',
                    'ticket_by_rand' => 'ticket/rand',
                    'campaign_check' => '/campaign/check',
                    'campaign_ticket' => '/campaign/ticket',
                    'save_ticket' => '/save/ticket',
                    'campaign_by_gift' => '/campaign/id',
                    'hapitas_moved_check' => 'hapitas/moved/check',
                    'hapitas_locked' => 'hapitas/locked',
                    'hapitas_point' => 'hapitas/point',
                    'hapitas_subtraction' => 'hapitas/subtraction',
                    'hapitas_cooperation' => 'hapitas/cooperation',
                    'zoto_realtime' => 'realtime',
                    'ticket_set_used' => 'ticket/isused/set',
                    'ticket_is_used' => 'ticket/isused',
                    'services' => 'services',
                    'current_campaign' => 'campaign/current',
                    'gmo_rakutenid_payment_entry' => 'gmo/payment/rakutenid/entry',
                    'gmo_rakutenid_payment_exec' => 'gmo/payment/rakutenid/exec',
                    'gmo_docomo_payment_entry' => 'gmo/payment/docomo/entry',
                    'gmo_docomo_payment_exec' => 'gmo/payment/docomo/exec',
                    'gmo_au_payment_entry' => 'gmo/payment/au/entry',
                    'gmo_au_payment_exec' => 'gmo/payment/au/exec',
                    'gmo_recruit_payment_entry' => 'gmo/payment/recruit/entry',
                    'gmo_recruit_payment_exec' => 'gmo/payment/recruit/exec',
                    'payment_create_process' => 'payment/create/process',
                    'payment_types' => 'payment/types',
                    'faq' => 'faq',
                    'search_by_mail' => 'member/search/mail',
                    'campaign_backnumber' => '/campaign/backnumber',
                    'cardmessage_open' => '/cardmessage/open',
                    'message_set' => '/message/set',
                    'message_set_readat' => '/message/read/set',
                    'message_mail_set' => '/message/mail/set',
                    'get_messages' => '/messages',
                    'get_message_by_id' => '/message/get',
                    'double_account' => '/double/account',
                    'backnumber_campaigns' => 'campaign/backnumber',
                    'check_member_order_count' => '/check/member/order/count',
                    'check_ip_payment_count' => '/check/ip/payment/count',
                    'check_browser_payment' => '/check/browser/count',
                    'hapitas_secret_question_check' => '/hapitas/secret/question/check',
                    'hapitas_check_tracks_counts' => '/hapitas/tracks/counts/check',
                    'save_encode_credit' => 'save/encode/credit',
                    'check_encode_credit' => 'check/encode/credit',
                    'sms_send' => 'sms/send',
                    'sms_status' => 'sms/status',
                    'update_traded_encode_card' => 'traded/encode/card/update',
                    'check_encode_credit_traded' => 'check/encode/credit/traded',
                    'get_sms_message' => 'sms/message/get',
                    'check_sms_auth_code' => 'sms/auth/code/check',
                    'agreement_set' => 'member/agreement/set',
                    'social_login' => 'login/social',
                    'social_register' => 'register/social/facebook',
                    'fb_user_data' => 'social/facebook/set',
                    'set_fb_friend_data' => 'social/facebook/friend/set',
                    'social_user_check' => 'social/member/check',
                    'find_fb_user_data' => 'social/facebook/find',
                    'fb_cooperation' => 'social/facebook/cooperation',
                    'starbucks_ticket_payout' => 'starbucks/ticket/pay_out',
                    'starbucks_ticket_status' => 'starbucks/ticket/status',
                    'star_recieved' => 'star/recieved',
                    'star_purchase_set' => 'star/purchase/set',
                    'star_send_log_set' => 'star/send/log/set',
                    'star_save' => 'star/save',
                    'star_ticket' => 'star/ticket',
                    'star_counts' => 'star/counts',
                    'star_purchase_history' => 'star/purchase/history',
                    'mvp_tester_member_id' => 'mvp/tester/member/id',
                    'mvp_tester_member_check' => 'mvp/tester/member/check',
                    'hipchat_all_users' => 'hipchat/all/users',
                    'hipchat_send_message' => 'hipchat/send/message',
                    'gmo_payment_result_callback' => '/gmo/payment/result/callback',
                    'card_create_info_save' => '/card/create/info/save',
                    'send_log_save' => '/send/log/save',
                    'ticket_relation_open' => '/cardmessage/relation/open',
                    'member_device' => '/member/device',
                    'inactive_ticket' => '/inactive/ticket',
                    'inactive_ticket_check' => '/inactive/ticket/check',
                    'check_referrer_inactive_gift' => '/member/check/referrer/inactive/gift',
                    'set_activation_ticket' => '/activation/ticket',
                    'is_activation_ticket_check' => '/is/activation/ticket/check',
                    'set_ticket_returened' => '/set/ticket/returened',
                    'inactive_ticket_count' => '/inactive/ticket/count',
                    'referrer_inactive_gift_rand' => '/member/referrer/inactive/gift/rand',
                    'set_friends' => '/friends/set',
                    'friends_list' => '/friends',
                    'friend_delete' => '/friend/delete',
                    'is_ticket_saved' => '/is/ticket/saved',
                    'active_ticket_by_inactive_rand' => '/active/ticket/by/inactive/rand',
                    'is_returned_ticket_check' => '/is/returned/ticket/check',
                ),
            ),
            'cookie' => array(
                'key' => array(
                    'memberId' => '2d376140530cea39187b057cec42f76a',
                    'giftId' => 'giftId',
                    'cardId' => 'cardId',
                    'nickname' => 'nickname',
                    'msg' => 'msg',
                    'movieId' => 'movieId',
                    'passToken' => 'f94c969be8fe856564195fc7d96b3c66',
                    'imageName' => 'imageName',
                    'ref' => 'ref',
                    'ide' => 'ide',
                    'tRandId' => 'tRandId',
            ...
            'serializer.mapping.cache.prefix' => 'serializer_99172e95bb1ce2f8428f21ef9678588e20aaa76ac61e6f224b2dcabfeb7f5163',
            ...
            'twig.exception_listener.controller' => 'AppBundle:CustomException:show',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'mail01.zoto.gift',
            'swiftmailer.mailer.default.transport.smtp.username' => 'cs',
            'swiftmailer.mailer.default.transport.smtp.password' => 'oz-vision123',
            ...
            'doctrine.connections' => array(
                'delos' => 'doctrine.dbal.delos_connection',
