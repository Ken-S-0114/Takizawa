...
<head>
	...
	<link rel="apple-touch-icon" href="http://zoto.gift/bundles/framework/images/icon_logo.png" />
	<link rel="shortcut icon" href="http://zoto.gift/bundles/framework/images/icon_logo.png" />
	<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
	<link rel="stylesheet" href="http://zoto.gift/bundles/framework/css/top.css" type="text/css" />
	<link rel="stylesheet" href="http://zoto.gift/bundles/framework/css/common.css" type="text/css" />
	<script src="http://zoto.gift/bundles/framework/js/pagetop.js"></script>
	<script>
		$(function() {
